...
export default function SignUp() {
  ...
  return (
    <main className="h-screen w-full flex flex-col items-center">
      <section className="flex-1 flex flex-col justify-center space-y-4 px-8 w-lg">
        ...
        <form className="flex flex-col w-full gap-4" action={formAction}>
          ...
          <button
            disabled={isPending}
            className="transition bg-white/5 hover:bg-white/10 cursor-pointer text-sm w-full rounded-lg py-2 text-white/80"
          >
